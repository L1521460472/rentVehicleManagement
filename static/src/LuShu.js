...
(function () {
     ...
     */
     BMapLib.LuShu = function (map, path, opts,mycaiId) {
    ...
    */
    ...
    LuShu.prototype.stop = function () {
        ...
        this._clearTimeout(this._timeoutFlag);
    ...
    baidu.object.extend(LuShu.prototype, {
         ...
         * @return 无返回值.
         */
        _move: function (initPos, targetPos, effect,mycaiId) {
            ...
            var me = this,
				...
				//count1 += Math.round(me._getDistance(init_pos, target_pos));
				
				 count1 +=Math.round(me._getDistance(init_pos, target_pos));
				// console.log('两点距离:'+me._getDistance(init_pos, target_pos));
				// console.log('步长:'+count);
