<template>
  <div class="container">
      ...
      <div class="search scoped">
        ...
        <div class="searchitem">
          <label>充值状态</label>
          <el-select v-model="search.status" placeholder="全部" size="small">
              <el-option value="" label="全部"></el-option>
              <el-option value="0" label="充值中"></el-option>
     ...
     <el-table :data="dataList" border class="table" stripe :height="tableHeight"
      ...
      v-loading="loading">
       ...
       <el-table-column prop="transactionNo" width="250" label="流水编号" show-overflow-tooltip></el-table-column>
       <el-table-column prop="orderNo" width="300" label="订单编号" show-overflow-tooltip></el-table-column>
       <el-table-column prop="payTypeStr" width="100" label="充值类型"></el-table-column>
       <el-table-column prop="chargeMoney" width="100" label="充值金额"></el-table-column>
       <el-table-column prop="afterMoney" width="100" label="充值后余额"></el-table-column>
       <el-table-column prop="createTime" width="200" label="充值时间"></el-table-column>
       <el-table-column prop="statusStr" width="100" label="充值状态"></el-table-column>
       <el-table-column prop="statusDesc" width="100" label="状态描述"></el-table-column>
     </el-table>
...
import { getCookie, formatDate,formatJE } from "@/public";
  export default{
    ...
    methods:{
      ...
      daochu(){
        let filename="充值记录.xls"
        let path="/platform-base-service/rechargeRecord/listExport"//导出
        //导出
        axios({
          method: "post",
          url: path,
      ...
      getlist(){
          ...
          axios({
            method: "post",
            url:'/platform-base-service/rechargeRecord/listPage',
            data:this.search,
            headers:this.headers
          })
          .then((result)=>{
            ...
            if(result.data&&result.data.data){
              ...
              for(let item of this.dataList){
                item['chargeMoney']=formatJE(item['chargeMoney'])
