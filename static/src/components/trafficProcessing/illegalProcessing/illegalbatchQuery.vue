          ...
          <el-table :data="dataList" border stripe :height="tableHeight" size="small"
            ...
            <el-table-column prop=""  label="查看结果" width="205px"  align="center">
              <template slot-scope="scope">
                ...
                <a v-if="btn5" href="javascript:;" class="alink" @click="exportcount(scope.row)">导出条数</a>
                <a v-if="btn6" href="javascript:;" class="alink" @click="exportdetail(scope.row)">导出详情</a>
              </template>
            </el-table-column>
          </el-table>
