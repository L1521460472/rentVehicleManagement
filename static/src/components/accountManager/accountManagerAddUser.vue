      ...
      <div class="footerNav">
        <el-form ref="form" :model="form" label-width="130px">
          <div class="formNav" v-if="international.content">
            <el-form-item label="所属公司"><b id="xlabel">*</b>
              <el-select size="small" filterable v-model="form.enterpriseId">
                <el-option v-for="item in optionsAffiliation" :key="item.id" :label="item.enterpriseName"  :value="item.id" >
                </el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item :label="international.content.content_userProfile_userAccount">
              <b id="xlabel">*</b>
          ...
          <div class="footerButton" v-if="international.content">
            <el-button type="primary" size="small" v-if="showButton" @click="addConfirm">
...
export default {
  ...
  methods: {
    addConfirm() {
      ...
      this.timer = setTimeout(function () {
        ...
        axios({
          method: "post",
          url: "/platform-base-service/accountManage/insertUser",
  ...
  mounted() {
    ...
    if (this.$route.query.form == "add") {
      ...
      axios({
        method: "get",
        url: "/platform-base-service/platformBaseUserInfo/userDetails?id=" + this.$route.query.id,
        headers: this.headers,
      })
        .then((result) => {
          if (result.data.status === 0) {
