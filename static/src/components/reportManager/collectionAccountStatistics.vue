<template>
  <div class="container">
      <div class="search scoped">
        ...
        <div class="searchitem">
          <label>选择年月</label>
         <el-date-picker v-model="search.yearAndMonth" type="month" placeholder="" value-format="yyyy-MM"></el-date-picker>
        </div>
        <div>
     ...
     <el-table :data="dataList" border class="table" stripe :height="tableHeight" size="small"
      ...
      <el-table-column type="index" label="序号" width="50" align="center">
       ...
       <el-table-column prop="collectionAccountType" label="账户类型"></el-table-column>
       <el-table-column prop="accountNumber" label="卡号"></el-table-column>
       <el-table-column prop="collectionMoney" label="收款"></el-table-column> 
     </el-table>
...
import getEnterpriseBox from '@/components/aacommon/getEnterpriseBox.vue'
  export default{
    ...
    data(){
      return {
        search:{
          ...
          "currentPage": 1,
          "pageSize": 10,
          "yearAndMonth":formatDate(new Date(),'yyyy-MM')
        },
        loading:false,
        dataList:null,
        total:0,
    ...
    methods:{
      onexport(){
        axios({ method: "post",
         url: `/vehicle-service/collectionAccountInfo/collectionAccountStatisticsExport?enterpriseId=${this.search.enterpriseId}`,
      ...
      getlist(){
          ...
          axios({
            method: "post",
            url:'/vehicle-service/collectionAccountInfo/collectionAccountStatistics',
            data:this.search,
