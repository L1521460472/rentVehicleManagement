  ...
  <div class="container">
     ...
     <el-table :data="dataList" border class="table" stripe :height="tableHeight" size="small"
      ...
      <el-table-column type="index" label="序号" width="50" align="center">
       ...
       <el-table-column prop="vehicleNums" label="车辆数量"></el-table-column>
       <el-table-column prop="leasedNums" label="已出租数量"></el-table-column>
       <el-table-column prop="yearlyInsDueNums" label="年检到期数量"></el-table-column>
       <el-table-column prop="compulsoryInsDueNums" label="交强险到期数量"></el-table-column>
       <el-table-column prop="commercialInsDueNums" label="商业险到期数量"></el-table-column>
...
import getEnterpriseBox from '@/components/aacommon/getEnterpriseBox.vue'
  export default{
    ...
    methods:{
      onexport(){
        axios({ method: "get",
        url: `/vehicle-service/brandInfo/brandVehicleTypeVehicleNumExport?enterpriseId=${this.search.enterpriseId}`,
         headers: this.headers, data:this.search, responseType: 'blob'})
          .then((result) => {
            if (result.data.type === "application/json") {
                ...
                link.download = `品牌车型车辆数报表${formatDate(new Date(),"YYYYMMDDHHmmss")}.xls`;
      ...
      getlist(){
          ...
          axios({
            method: "post",
            url:'/vehicle-service/brandInfo/brandVehicleTypeVehicleNum',
            data:this.search,
