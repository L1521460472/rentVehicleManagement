                    ...
                    <div class="itemitem" style="width: 250px;" v-for="item in changguiitems" :key="item.type">
                      ...
                      <div class="itemitem-r itemitem-r3">
                        <div :class="item.checked?'itemitem-r3-v4':'itemitem-r3-v'">
                          <el-input v-model="item.count" :disabled="true"></el-input> 元
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="item">
          ...
          <div class="itemcontant">
            ...
            <div class="itemitem">
              ...
              <div class="itemitem-r">
               <el-input v-model="shenhedata.auditSuggestion"  type="textarea" :rows="3"
            ...
            <div class="itemitem" style="margin-bottom: 25px;margin-top: 25px;display: block;">
              <div style="width: 100%;text-align: center;">
                <el-button @click="shenhe()" type="primary" v-if="btn1">确认</el-button>
      ...
      shenhe(){
          if(!this.shenhedata.auditSuggestion){
            ...
            return
             ...
             this.$axios.post('/vehicle-service/repairManagement/repairAudit',this.shenhedata,{headers:this.headers})
             .then((res)=>{
      ...
      .then((res)=>{
        ...
        if(data){
          ...
          if(data.repairManagement){
            ...
            data.repairManagement.auditStatus="1"//默认通过
            this.shenhedata.auditSuggestion =data.repairManagement.auditSuggestion
          }
