...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      axios({
        method: "post",
        url: "/platform-base-service/platformManageUserAuthoritySetting/save",
    ...
    onSubmitEdit() {
      ...
      axios({
        method: "post",
        url: "/platform-base-service/platformManageUserAuthoritySetting/update",
        headers: this.headers,
        data: this.form,
      })
        .then((result) => {
  ...
  mounted() {
    ...
    if (this.$route.query.form == 'add') {
      ...
      axios({
        method: "get",
        url:
          "/platform-base-service/platformManageUserAuthoritySetting/getManageUserAuthorityDetail?id=" +
          this.$route.query.id,
        headers: this.headers,
      })
        .then((result) => {
  ...
  watch: {
    ...
    internationalTitle: {
      handler(data) {
        ...
        if(this.$route.query.form == 'add'){
            this.showMes = this.international.title ? this.international.title.title_operationUserPermission_addUser:'';
        }else{
            this.showMes = this.international.title ? this.international.title.title_operationUserPermission_editUser:'';
        }
      },
      immediate: true,
      deep: true,
