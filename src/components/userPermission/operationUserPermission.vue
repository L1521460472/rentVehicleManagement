    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          class="cancel"
          size="small"
          @click="dialogVisibleFunction = false"
        ...
        <div class="footer_informatian" v-if="international.field">
          ...
          >
            ...
            <el-table-column
              ...
              width="60"
              :label="
                international.field.field_operationUserPermissionList_number
              "
              align="center"
            >
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              :label="
                international.field
                  .field_operationUserPermissionList_userAccount
              "
            >
            </el-table-column>
            <el-table-column
            ...
            <el-table-column
              ...
              show-overflow-tooltip
              :label="
                international.field.field_operationUserPermissionList_email
              "
            >
            </el-table-column>
            <el-table-column
              ...
              width="110"
              :label="
                international.field.field_operationUserPermissionList_iphone
              "
              show-overflow-tooltip
            >
            </el-table-column>
            <el-table-column
              ...
              show-overflow-tooltip
              :label="
                international.field.field_operationUserPermissionList_status
              "
            >
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              :label="
                international.field
                  .field_operationUserPermissionList_affiliation
              "
            >
            </el-table-column>
            <el-table-column
              ...
              :label="
                international.field
                  .field_operationUserPermissionList_functionalAuthority
              "
            >
            </el-table-column>
            <el-table-column
              ...
              :label="
                international.field
                  .field_operationUserPermissionList_dataAuthority
              "
            >
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    search() {
      ...
      axios({
        method: "post",
        url:
          "/platform-base-service/platformManageUserAuthoritySetting/listManageUserAuthorityByPage",
    ...
    FunctionalAuthority() {
      ...
      axios({
        method: "post",
        url:
          "/platform-base-service/platformBaseRole/listManageUserFunctionAuthorityByPage",
        headers: this.headers,
        data: {
    ...
    confirmFunction() {
      ...
      axios({
        method: "post",
        url:
          "/platform-base-service/platformManageUserAuthoritySetting/function/authority/bind",
        headers: this.headers,
        data: {
          // roleId: this.showClick == true ? this.multipleSelection[0].id : "",
    ...
    DataAuthority() {
      ...
      axios({
        method: "post",
        url:
          "/platform-base-service/platformBaseRole/listManageUserDataAuthorityRoleByPage",
        headers: this.headers,
        data: {
          currentPage: this.currentPage,
    ...
    confirmData() {
      ...
      axios({
        method: "post",
        url:
          "/platform-base-service/platformManageUserAuthoritySetting/date/authority/bind",
        headers: this.headers,
        data: {
          roleId: this.functionRadio,
          userIds: this.userIds,
      ...
      this.$confirm(this.international.global.global_confirmDeactive, {
        ...
        .then(() => {
          ...
          axios({
            method: "post",
            url:
              "/platform-base-service/platformManageUserAuthoritySetting/status/disabled",
            headers: this.headers,
            data: {
              ids: arr,
            },
      ...
      this.$confirm(this.international.global.global_confirmActive, {
        ...
        .then(() => {
          ...
          axios({
            method: "post",
            url:
              "/platform-base-service/platformManageUserAuthoritySetting/status/enabled",
            headers: this.headers,
            data: {
              ids: brr,
            },
  ...
  watch: {
    ...
    "$store.getters.isStatus": function () {
      if (this.$store.state.isStatus == true && this.$route.path == '/addOperationUser') {
        this.getDataList();
      }
    },
  },
