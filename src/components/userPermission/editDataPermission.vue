    ...
    <el-dialog
            ...
            >
              ...
              <div style="margin-top: 10px;" v-if="showRule">
                <el-button size="small" @click="confirmAddRule">{{
                  international.global.global_confirm
                }}</el-button>
                <el-button size="small" @click="cancelRule">{{
                  international.global.global_cancel
                }}</el-button>
              </div>
              <div style="margin-top: 10px;" v-else>
                <el-button size="small" @click="confirmEditRule">{{
                  international.global.global_confirm
                }}</el-button>
                <el-button size="small" @click="cancelRule">{{
                  international.global.global_cancel
  ...
  watch: {
    ...
    internationalTitle:{
        handler(data){
          ...
          this.showMes = this.international.title
            ? this.international.title.title_dataPermissionSettings_updateDataRole
            : "";
        }
        },
        immediate:true,
