        ...
        <div class="footerNav">
          <el-form :model="form" label-width="130px" label-position="right">
            ...
            <el-form-item class="formItem" label="客户-身份证号码">
              <el-input maxlength="100" size="small" disabled v-model="form.customerIdNumber"></el-input>
            </el-form-item>
            <el-form-item class="formItem" label="客户-驾驶证号码">
              <el-input maxlength="100" size="small" disabled v-model="form.customerDriverNumber"></el-input>
            </el-form-item>
          </el-form>
          <div class="attachment">
            <div class="attachmentLeft">
              <el-upload
                ...
                multiple
              >
                <span class="disabled_txt">身份证正面</span>
              </el-upload>
            </div>
            <div class="attachmentRight">
              <el-upload
                ...
                multiple
              >
                <span class="disabled_txt">驾驶证</span>
              </el-upload>
            </div>
          </div>
          <div class="attachment">
            <div class="attachmentLeft">
              <el-upload
                ...
                multiple
              >
                <span class="disabled_txt">身份证反面</span>
              </el-upload>
            </div>
            <div class="attachmentRight">
              <el-upload
                ...
                multiple
              >
                <span class="disabled_txt">营业执照</span>
              </el-upload>
            </div>
          </div>
          <!-- 图片放大 -->
        ...
        <div class="footerNav">
          <el-form ref="form" :model="form" label-width="130px" label-position="right">
            <el-form-item label="审核结果">
              <el-radio
                v-model="radio"
                :disabled="$route.query.from == 'audit' ? false:true "
                :label="3"
              >通过</el-radio>
              <el-radio
                v-model="radio"
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          let params = {
            ...
            auditStatus: this.radio == 3 ? 1:2
          };
          auditOrder(params, this.headers)
            .then((res) => {
              if (res.status == 0) {
      ...
      getOrderDetail({ id: this.$route.query.id }, this.headers)
        .then((res) => {
          if (res.status == 0) {
            ...
            this.radio = res.data.orderStatus;
...
#auditOrder >>> .el-dialog__body {
  padding: 0;
}
#auditOrder >>> .el-dialog__header {
  padding: 0;
}
#auditOrder >>> .el-dialog__headerbtn {
  top: -11px;
  right: -15px;
  color: #fff;
  opacity: 1;
}
#auditOrder >>> .el-dialog__close {
  color: #fff;
}
.el-dialog__body img {
  display: block;
