  ...
  <div>
    ...
    <div class="footer" >
        <el-table v-loading="loading"  border  stripe :header-cell-style="{background:'#F5F7FA',color:'#333333'}"
          size="small" :data="tableData" :height="tableHeight" style="width: 100%;">
          <el-table-column prop width="60" label="序号" align="center">
            <template slot-scope="scope">{{ scope.$index + (searchform.currentPage - 1) * searchform.pageSize + 1 }}</template>
          </el-table-column>
          ...
          <el-table-column prop="rentMoney" label="抵扣金额"  width="120"></el-table-column>
