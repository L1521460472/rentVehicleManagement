      ...
      <div class="footerTop">
        ...
        <div class="footerNav">
          <el-form ref="form" :model="form" label-width="135px" label-position="right">
            ...
            <makeSelect v-model="form.reductionType" :options="[{name:'故障/维修抵扣',value:1},{
...
export default {
  ...
  methods: {
        ...
        if(valid){
          ...
          this.timer = setTimeout(function () {
            ...
            let params = {
              ...
              reductionType:_this.form.reductionType,
              collectionType:_this.form.collectionType
            };
            _this.$axios.post(
                '/vehicle-service/leaseContractInfo/rentDeductionSubmit',
                params,
    ...
    // 获取缴费详情数据
    getDetail(){
      payFeeDetail({ id: this.$route.params.id,collectionType:this.$route.params.collectionType,type:2 }, this.headers)
      .then((res) => {
        if (res.status == 0) { 
            setTimeout(() => {
            window.onload()
