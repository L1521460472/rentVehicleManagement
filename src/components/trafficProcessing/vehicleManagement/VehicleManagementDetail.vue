    ...
    <div class="footer">
      <div class="footerNav">
        ...
        <el-form ref="formVeInformation" :model="formVeInformation" label-width="120px">
          <div class="formNav formNavs" style="position: relative;">
            <el-form-item label="车牌号码" prop="vehicleNo">
              <el-input class="formItem" size="small" :disabled="isOperation" maxlength="100"
              v-model="formVeInformation.vehicleNo" ></el-input>
              <a href="javascript:;" @click="editVehicleNo" style="position: absolute; width: 71px; font-size: 14px; color: #368cfe; text-decoration: none;"><i class="el-icon-edit"></i>修改</a>
            </el-form-item>
            <el-form-item label="车架号" prop="vinNo">
              <el-input class="formItem" size="small"
                :disabled="isOperation" maxlength="100" v-model="formVeInformation.vinNo"></el-input>
            </el-form-item>
            <el-form-item
              label="发动机号"
              prop="engineNo">
      ...
      <el-dialog :visible.sync="showchangevehicleno" title="变更车牌号"
       width="650px" :destroy-on-close="true" :close-on-click-modal="false"
      :append-to-body="true">
        <components :is="changeVehicleNo" :id="formVeInformation.id" :vehicleno="formVeInformation.vehicleNo"
...
import changeVehicleNo from '@/components/trafficProcessing/vehicleManagement/changeVehicleNo.vue'
export default {
  name: "VehicleManagementDetail",
  components:{changeVehicleNo},
  data() {
    return {
  ...
  methods: {
      ...
      callback(newvehicleNo){
         this.showchangevehicleno=false
         this.formVeInformation.vehicleNo=newvehicleNo
