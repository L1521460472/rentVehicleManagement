        ...
        <el-form ref="formContract" :model="formContract" label-width="130px">
          <div class="formNav formNavs">
            ...
            <div class="cctvTable">
              ...
              >
                <el-table-column prop="billPeriods" width="80" label="合同期数"></el-table-column>
              ...
              <el-tabs :tab-position="tabPosition" type="border-card" style="height: 500px;">
                <el-tab-pane label="汇总">
                  ...
                  >
                    ...
                    <el-table-column prop="collectionStatusStr" label="当期收款状态" width="100" :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="lateFee" label="滞纳金" width="80" ></el-table-column>
                    <el-table-column prop="overdueDays" label="超期天数" width="80" :show-overflow-tooltip="true"></el-table-column>
          ...
          <div class="formNav formNew">
            <el-form-item>
              ...
              <div class="tableList">
                <li>备注</li>
                <li>
                  <el-input type="text" size="mini" v-model="value11"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value12"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value13"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value14"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value15"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value16"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value17"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value18"></el-input>
                </li>
                <li>
                  <el-input type="text" size="mini" v-model="value19"></el-input>
                </li>
                <li>
            ...
            >
              <el-select v-model="formBackVehicle.backOffType" size="small" filterable placeholder>
                <el-option
  ...
  methods: {
    confirm() {
      ...
      if (
        ...
        this.formBackVehicle.oweRent === "" ||
        this.formBackVehicle.lateFee === "" ||
        this.formBackVehicle.damages == "" ||
        this.formBackVehicle.regulationsDeduction == "" ||
        this.formBackVehicle.comeUpMoney == "" ||
      ...
      this.formBackVehicle.contractId = this.$route.query.id;
      this.formBackVehicle.remakeList = [];
      this.formBackVehicle.remakeList.push(this.value11);
      this.formBackVehicle.remakeList.push(this.value12);
      this.formBackVehicle.remakeList.push(this.value13);
      this.formBackVehicle.remakeList.push(this.value14);
      this.formBackVehicle.remakeList.push(this.value15);
      this.formBackVehicle.remakeList.push(this.value16);
      this.formBackVehicle.remakeList.push(this.value17);
    ...
    changeVehicleRent() {
      //计算结算余额
      if(this.formBackVehicle.oweRent > 0){
        this.formBackVehicle.oweRent = -this.formBackVehicle.oweRent;
      }
      if(this.formBackVehicle.lateFee > 0){
        this.formBackVehicle.lateFee = -this.formBackVehicle.lateFee;
      }
      if(this.formBackVehicle.damages > 0){
        this.formBackVehicle.damages = -this.formBackVehicle.damages;
      }
      if(this.formBackVehicle.regulationsDeduction > 0){
        this.formBackVehicle.regulationsDeduction = -this.formBackVehicle.regulationsDeduction;
      }
      if(this.formBackVehicle.certifiReplaceMoney > 0){
        this.formBackVehicle.certifiReplaceMoney = -this.formBackVehicle.certifiReplaceMoney;
      }
      if(this.formBackVehicle.vehicleDamageDeduction > 0){
        this.formBackVehicle.vehicleDamageDeduction = -this.formBackVehicle.vehicleDamageDeduction;
      }
      if(this.formBackVehicle.comeUpMoney > 0){
        this.formBackVehicle.comeUpMoney = -this.formBackVehicle.comeUpMoney;
      }
      if(this.formBackVehicle.otherDeduction > 0){
        this.formBackVehicle.otherDeduction = -this.formBackVehicle.otherDeduction;
      }
      ...
      this.formBackVehicle.backOffMoney = this.formBackVehicle.backOffMoney.toFixed(1);
    },
    getVehicle() {
      //合同查询车辆
      axios({
    ...
    getInitData() {
      ...
      axios({
        method: "get",
        url:
          "/vehicle-service/backOffVehicleInfo/goReturnCarSettlement?id=" +
          this.$route.query.id,
        headers: this.headers,
      })
        .then((result) => {
          ...
          if (result.data.status === 0) {
            ...
            this.formBackVehicle.oweRent = result.data.data.oweRent;
            this.formBackVehicle.lateFee = result.data.data.lateFee;
            this.formBackVehicle.damages = result.data.data.damages;
            this.formBackVehicle.regulationsDeduction = result.data.data.regulationsDeduction;
            this.formBackVehicle.comeUpMoney = result.data.data.comeUpMoney;
            this.formBackVehicle.vehicleDamageDeduction = result.data.data.vehicleDamageDeduction;
            this.formBackVehicle.certifiReplaceMoney = result.data.data.certifiReplaceMoney;
            this.formBackVehicle.otherDeduction = result.data.data.otherDeduction;
            this.formBackVehicle.backOffMoney = result.data.data.backOffMoney;
            this.formBackVehicle.backOffType = result.data.data.backOffType;
            this.formBackVehicle.backOffDate = result.data.data.backOffDate;
...
debugger
            ...
            for (var i in this.formContract.leaseContractGenerateTableVO.vehicleMap) {
              this.formContract.leaseContractGenerateTableVO.vehicleMap[i] = this.mergeTableRow(this.formContract.leaseContractGenerateTableVO.vehicleMap[i]).slice(0);
            }
          } else {
            this.$message({
              message: result.data.message,
