  ...
  methods: {
    confirm() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          axios({
            method: "post",
            url: "/vehicle-service/leaseContractInfo/auditLeaseContractInfo", //+this.vehicleTypeId
    ...
    getInitData() {
      ...
      axios({
        method: "get",
        url:
          "/vehicle-service/leaseContractInfo/goPlanAuditPage?id=" +
          this.$route.query.id,
        headers: this.headers,
      })
        .then((result) => {
          ...
          if (result.data.status === 0) {
            ...
            this.formContract.supplefileIdList = result.data.data.supplefileIdList ; //合同附加附件
            ...
            // this.formContract.vehicleList.vehicleColor = result.data.data.leaseContractVehicleInfoVOList.vehicleColorName;//车辆颜色
            // this.formContract.vehicleList.vehicleType = result.data.data.leaseContractVehicleInfoVOList.vehicleTypeName;//车辆颜色
