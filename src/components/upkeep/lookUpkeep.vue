        ...
        <div class="item">
          ...
          <div class="itemcontant">
            <div class="itemitem">
              ...
              <div class="itemitem-r">
                <el-input v-model="data.maintainManagement.auditStatusStr" :disabled="true"></el-input>
              </div>
            </div>
            <br>
            <div class="itemitem">
              <div class="itemitem-1 auditResult">核实意见</div>
              <div class="itemitem-r">
                <el-input
                    disabled
                    type="textarea"
                    ...
                    :autosize="{ minRows: 4, maxRows: 6 }"
                    show-word-limit
                    v-model="data.maintainManagement.auditSuggestion"
                  ></el-input>
              </div>
            </div>
            <br>
    ...
    data(){
      return {
          ...
          data:{
             ...
             maintainManagement:{},
             maintainManagementCustomList:[],
             maintainManagementBasicsList:[],
             maintainManagementDeepList:[]
          },
          vehicledata:[],
          fileList:[],
          indexkey:-1,
